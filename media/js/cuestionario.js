...
preguntas[2] = new pregunta("(3) ¿Método más efectivo para resolver la minimización de funciones booleanas con más de 6 variables?","A) Minimización por Quine-McCluskey","B) Tablas de verdad","C)Un término que no puede combinarse con otro para seguir simplificándose","D) Tablas de implicantes primos esenciales", 0);
preguntas[3] = new pregunta("(4) ¿Qué representa un implicante primo en el método Quine-McCluskey?","A) Un término que solo aparece una vez en la función ","B) Una variable no esencial para la simplificación ","C) Un término que no puede combinarse con otro para seguir simplificándose ","D)Ninguna de las anteriores" ,2);
